...
LegoCV is OpenCV framework bult for Swift and Objective-C. It eliminates the need to use Objective-C++ and allows full compatibility with native Swift projects. The only dependency is native [OpenCV framework](http://opencv.org).
